...
#         self.pipeline = self._init_llm(model_name)
...
#         """System prompt tối ưu cho Sign Language"""
#         return """You are a Sign Language translation expert. 
# Convert sentences to simple German words suitable for sign language.
# Rules:
# 1. Use simple, common German words
# 2. Follow sign language word order (Subject-Object-Verb)
# 3. Generate 5 different variants with decreasing complexity
# 4. Each variant on a new line
# 5. Use only basic vocabulary

# Example:
# Input: "I want to go to the market later to buy apples"
# Output:
# ich später markt gehen kaufen apfel
# ich später markt kaufen
# ich markt gehen später
# ich kaufen essen später
# ich später kaufen essen

# Generate 5 variants only, no explanations."""

#     def _generate_candidates(self, text: str, num_variants: int = 5) -> List[str]:
...
#     print("="*60)
#     print("SIGN LANGUAGE MAPPER - TEST RESULTS")
#     print("="*60)
